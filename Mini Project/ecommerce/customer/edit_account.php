...
<form action="" method="post" enctype="multipart/form-data">
			...
			<table align="center" width="750">
				...
				<tr>
					...
					<td><input type="file" name="c_image"/><img src="customer_images/<?php echo $image; ?>" width="100" height="150"/></td>
				</tr>
				...
				<tr>
					...
					<td><textarea cols="22" rows="5" name="c_address" value="<?php echo $address; ?>"/></textarea></td>
				</tr>
