...
<section>
  ...
  <tr>
  <td> <label>Regulation Name </label> </td>
...
mysql_select_db("BMS",$connection);
    ...
    { 
    $query=mysql_query("select * from regulation");
...
echo "<td> <a href=delete_regulation.php?Regulation=".$display['Regulation'].">Delete</a></td>";
echo "</tr>";
