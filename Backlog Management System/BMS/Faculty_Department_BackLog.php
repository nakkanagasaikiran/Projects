...
<section>
        <div class="container">
           <div class="center wow fadeInDown">
                ...
                <p class="lead">
                <h2>Department Wise BackLogs List</h2>
				</p>
            </div>
            
          <div class="row contact-wrap "> 
                <div class="status alert alert-success" style="display: none"></div>
                <form class="contact-form"  method="POST" action="Faculty_Department_BackLog.php" enctype="multipart/form-data">
...
if(isset($_POST['submit']))
{
   ...
   $query=mysql_query("select * from backlogs where DeptName='$Deptname'  and Regulation='$Regulation' and AcademicYear='$AcademicYear' order by RollNo asc");
