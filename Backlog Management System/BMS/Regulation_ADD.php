...
$query=mysql_query("select * from regulation where Regulation='$Regulation'");

if(mysql_num_rows($query)>0)
{
    echo '<script>alert("Regulation Name is Already Used...")</script>';
}
else 
{     
mysql_query("insert into regulation values('$Regulation')"); 

echo '<script>alert("Regulation Details inserted Successfully....")</script>';
}
}
...
<section>
        ...
        <div class="col-sm-2">    
         ...
         <div class="col-sm-5">
          <input type="text"  name="Regulation"  class="form-control" placeholder="Enter Regulation Name" required>
            <br />
