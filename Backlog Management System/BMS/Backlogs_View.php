...
echo "<td> <a href=delete_Backlogs.php?RollNo=".$display['RollNo']."&Name=".$display['Name']."&Semester=".$display['Semester']."&SubjectCode=".$display['SubjectCode']."&deptname=".$Deptname."&Regulation=".$Regulation."&AcademicYear=".$AcademicYear.">delete</a> </td>";
