...
mysql_select_db("BMS",$connection); 
	...
	mysql_query("DELETE FROM backlogs WHERE RollNo='$RollNo' and Name='$Name' and Semester='$Semester' and SubjectCode='$SubjectCode' and DeptName='$deptname' and Regulation='$Regulation' and AcademicYear='$AcademicYear'")
			
?>
							 <h2>Deleted Student Successfully...</h2>
							 <label>
							 <a href='Backlogs_View.php'>Back List</a>
