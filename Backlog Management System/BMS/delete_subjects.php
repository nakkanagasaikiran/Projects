...
<?php
  ...
  mysql_select_db("BMS",$connection); 
	...
	$SubjectCode =$_REQUEST['SujectCode'];
	...
	// sending query	
	mysql_query("DELETE FROM subjects WHERE DeptName='$deptname' and SujectCode='$SubjectCode' and SubjectName='$SubjectName' and Semester='$Semester' and Regulation='$Regulation'")
		
		
?>

							 <h2>Deleted Subjects Successfully...</h2>
							 <label>
							 <b><a href='Subjects_View.php'>Back List</a></b>
							 </label>
