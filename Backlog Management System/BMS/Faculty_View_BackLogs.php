...
<section>
        <div class="container">
          ...
          <div class="row contact-wrap "> 
                ...
                <form class="contact-form"  method="POST" action="Faculty_View_BackLogs.php" enctype="multipart/form-data">
...
if(isset($_POST['submit']))
{
   ...
   $query=mysql_query("select * from backlogs where Regulation='$Regulation' and AcademicYear='$AcademicYear' order by DeptName , Semester,RollNo  asc");
