            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse navbar-right">
                     <ul class="nav navbar-nav">
                        ...
                        <li><a href="Faculty_Student_BackLog.php">Student Wise BackLogs</a></li>
                        <li><a href="Faculty_Subject_BackLog.php">Subject Wise BackLogs</a></li>
                        <li><a href="Faculty_Department_BackLog.php">Department Wise BackLogs</a></li>
                        <li><a href="Faculty_View_BackLogs.php">Total BackLogs</a></li>
...
<section>
        <div class="container">
           <div class="center wow fadeInDown">
                ...
                <p class="lead">
			    <h2>Student Wise BackLogs List</h2>
          ...
          <div class="row contact-wrap "> 
                ...
                <form class="contact-form"  method="POST" action="Faculty_Student_BackLog.php" enctype="multipart/form-data">
                    ...
                    <div class="col-sm-3">
						...
						<div class="form-group">
                            ...
                            <input type="text" name="rollno" class="form-control" required="required">
                        </div>
...
if(isset($_POST['submit']))
{
    ...
    $query=mysql_query("select DISTINCT RollNo, Name, AcademicYear, Regulation, DeptName from backlogs where DeptName='$Deptname' and RollNo='$rollno' and Regulation='$Regulation' and AcademicYear='$AcademicYear'");
...
if(isset($_POST['submit']))
{
   ...
   $query=mysql_query("select * from backlogs where DeptName='$Deptname' and RollNo='$rollno' and Regulation='$Regulation' and AcademicYear='$AcademicYear'");
