...
if(isset($_POST['submit']))
{
  ...
  $query=mysql_query("select * from subjects where DeptName='$Deptname' and Semester='$Semster' and Regulation='$Regulation'");
...
{
echo "<tr>";
echo "<td>" . $display['SujectCode'] . "</td>";
echo "<td>" . $display['SubjectName'] . "</td>";
echo "<td> <a href=delete_subjects.php?DeptName=".$Deptname."&Semester=".$Semster."&Regulation=".$Regulation."&SujectCode=".$display['SujectCode']."&SubjectName=".$display['SubjectName'].">Delete</a> </td>";
